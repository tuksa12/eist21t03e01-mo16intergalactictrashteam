...
public class Debris extends MovableObject{
     ...
     */
    public void split(){
        Debris d1 = new Debris(getPosition().getX(), getPosition().getY(), getMass()/2, getSpeed(), getDirection());
        Debris d2 = new Debris(getPosition().getX(), getPosition().getY(), getMass()/2, getSpeed(), getDirection());
        evaporate();
    }
